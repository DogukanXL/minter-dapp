const contractAddress = "0x4D1e5DA50e34c0F15804906376258bc2eA5A8bA2"; // Replace with your own contract address
const chain = 'rinkeby'; // rinkeby, polygon, or ethereum

const welcome_h1 = "Deneme Muz Projesine Hosgeldiniz!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'DAYI DENEME SITEMIZ NASIL OLMUS? :D Follow step by step on the <a href="https://youtube.com/codestackr"  target="_blank" rel="noopener noreferrer">codeSTACKr</a> YouTube channel.';
